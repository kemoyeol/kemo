...
if(isset($_POST['prescribe']) && isset($_POST['pid']) && isset($_POST['ID']) && isset($_POST['appdate']) && isset($_POST['apptime']) && isset($_POST['lname']) && isset($_POST['fname'])){
  ...
  $penyakit = explode('/', $diseases);
  $disease = $penyakit[0];
  $jenis = $penyakit[1];
  $grade = $penyakit[2];
  
  $query=mysqli_query($con,"insert into prestb(doctor,pid,ID,fname,lname,appdate,apptime,disease,allergy,prescription, jenisKanker, stadiumgrade) values ('$doctor','$pid','$ID','$fname','$lname','$appdate','$apptime','$disease','$allergy','$prescription', '$jenis', '$grade')");
    if($query)
    {
      echo "<script>alert('Resep telah ditentukan');</script>";
    }
    else{
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Rumah Sakit Profinsi Kota Mataram </a>
...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
     <ul class="navbar-nav mr-auto">
       ...
       <li class="nav-item">
       <a class="nav-link" href="doctor-panel.php"><i class="fa fa-sign-out" aria-hidden="true"></i>Kembali</a>
      </li>
    </ul>
  </div>
</nav>
...
<body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%;  padding-bottom: 20px; font-family: 'IBM Plex Sans', sans-serif;"> Selamat Datang, &nbsp<?php echo $doctor ?>
   </h3>
   ...
   <div class="tab-pane" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
        <form class="form-group" name="prescribeform" method="post" action="https://registrasi-kemoterapi.herokuapp.com/prescribe.php">
          ...
          <div class="row">
                  ...
                  <br><br><br><br>
          <input type="submit" name="prescribe" value="Tentukan" class="btn btn-primary" style="margin-left: 40pc;">
