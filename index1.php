...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, #3931af, #00c6ff); background-size: cover;">
    ...
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp Rumah Sakit Provinsi Kota Mataram</h4></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item" style="margin-right: 40px;">
            <a class="nav-link js-scroll-trigger" href="services.html" style="color: white;font-family: 'IBM Plex Sans', sans-serif;"><h6>Tentang</h6></a>
          </li>
    ...
    animation: mover 1s infinite alternate;">
          <img src="images/gambar2.png" alt="" style="width: 20%;padding-left: 40px;margin-top: 150px;margin-left: 45px;margin-bottom:15px">
      </div>

      <div style="color: white;">
            <h4 style="font-family: 'IBM Plex Sans', sans-serif;"> Login Untuk Pengobatan Kemoterapi</h4>
          </div>
            ...
            <div class="card-body">
              ...
              <form class="form-group" method="POST" action="https://registrasi-kemoterapi.herokuapp.com/func.php">
                <div class="row" style="margin-top: 10%">
                  ...
                  <div class="col-md-8" style="margin-top: 8%"><input type="password" class="form-control" name="password2" placeholder="*******" required/></div><br><br><br>
                </div>
                <div class="row">
