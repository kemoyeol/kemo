...
if(isset($_GET['cancel']))
  {
    ...
    if($query)
    {
      echo "<script>alert('Konsultasi Anda telah berhasil dibatalkan!');</script>";
    }
  }
...
.text-primary {
  ...
  <div class="col-md-4" style="max-width:18%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      <a class="list-group-item list-group-item-action active" href="#list-dash" role="tab" aria-controls="home" data-toggle="list">Dasbor</a>
      <a class="list-group-item list-group-item-action" href="#list-app" id="list-app-list" role="tab" data-toggle="list" aria-controls="home">Pengobatan Kemoterapi</a>
      <a class="list-group-item list-group-item-action" href="#list-pres" id="list-pres-list" role="tab" data-toggle="list" aria-controls="home"> Daftar Resepesep Pegobatan Kemoterapi</a>
               ...
               <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;"> Kemoterapi</h4>
                      <script>
                    ...
                    <div class="panel-body">
                      ...
                      <p class="links cl-effect-1">
                        <a href="#list-pres" onclick="clickDiv('#list-pres-list')">
                          Daftar Resep Pasien Kemoterapi
                        </a>
                      </p>
                    </div>
                  </div>
              ...
              <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col">ID Kemoterapi</th>
                    <th scope="col">Nama Depan</th>
                    <th scope="col">Nama Belakang</th>
                    <th scope="col">Jenis Kelamin</th>
                    <th scope="col">Email</th>
                    <th scope="col">Kontak</th>
                    <th scope="col">Tanggal Kemoterapi</th>
                    <th scope="col">Waktu Kemoterapi</th>
                    <th scope="col">Status Kemoterapi</th>
                    <th scope="col">Tindak Kemoterapi</th>
                    <th scope="col">Penentuan Kemoterapi</th>
                     ...
                     <td>
                        ...
                        { ?>
	                        ...
	                        <a href="doctor-panel.php?ID=<?php echo $row['ID']?>&cancel=update" 
                              onClick="return confirm('Apa Anda yakin ingin membatalkan konsultasi ini ?')"
                              title="Cancel Appointment" tooltip-placement="top" tooltip="Remove"><button class="btn btn-danger">Batal</button></a>
	                        <?php } else {
                        ...
                        <button class="btn btn-success">Tentukan</button></a>
                        <?php } else {
        ...
        <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Nama Belakang</th>
                    <th scope="col">ID Kemoterapi</th>
                    <th scope="col">TanggalKemoterapi</th>
                    <th scope="col">Waktu Kemoterapi</th>
                    <th scope="col">Jenis Kemoterapi</th>
                    <th scope="col">Berat badan / Tekanan Darah</th>
                    <th scope="col">Resep Obat Kemoterapi</th>
                  </tr>
                </thead>
                <tbody>
                  <?php 
              ...
              <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Chemotherapy Fees</th>
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="admin-panel1.php">
          <div class="row">
                  ...
                  <div class="col-md-4"><label>chemotherapy Fees:</label></div>
